...
{
    text.data = 'Dark Mode';
    document.body.style.backgroundImage = 'url(https://victalmeida.github.io/ono/assets/light.jpg)';
...
else
{
    ...
    document.body.style.backgroundImage = 'url(https://victalmeida.github.io/ono/assets/dark.jpg)';
